...
#define UCAP_SYNC	1
#endif
#if defined(UCAP_P10) && (defined(UCAP_SYNC) || defined(UCAP_PROBE) || defined(UCAP_P03))
#error "UCAP_P10 is exclusive with UCAP_SYNC/UCAP_PROBE/UCAP_P03"
#endif
#if defined(UCAP_P03) && (defined(UCAP_SYNC) || defined(UCAP_PROBE))
#error "UCAP_P03 is exclusive with UCAP_SYNC/UCAP_PROBE"
#endif
...
// 'W' marks the "P03 wake-line" receiver variant (ucap_p03.h).
#define DEF_SOFTWARE_REVISION	{'I', 'B', 'S', '-', 'W', '0' + (IBS_FW_VERSION / 10), '0' + (IBS_FW_VERSION % 10), 0}
#else
...
#endif
#if (defined(UCAP_P10) || defined(UCAP_P03)) && (DEV_SERVICES & (SERVICE_KEY | SERVICE_RDS | SERVICE_BUTTON | SERVICE_SCREEN))
#error "UCAP_P10/UCAP_P03 reuse PIN_INPUT_EVT/KEY_CHANGE_EVT/SBP_PROBE_EVT; these services own them"
#endif
/*
