...
| 2.1 | <ul><li>Изменен расчет усреднения напряжения батареи, переход в режим глубокого сна на 60 минут при падении напряжения ниже 1,9 В и отключение всех нагрузок.</li><li>Добавлены функции кнопок: «Автоматический переход дисплея в спящий режим», переключение отображения градусов Цельсия или Фаренгейта.</li><li>Исправление загрузки при включении питания в APP для TH04</li></ul> |
